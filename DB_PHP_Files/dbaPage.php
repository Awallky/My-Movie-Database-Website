          ...
          <div class="page-header">
            <h1>
              <p style="padding-left: 10cm;">
                Welcome to the best DB page dear administrator!
              </p>
            </h1>
            <form action="assignManager.php" method="get">
                <b>Assign manager role to E-mail: </b><input type="text" name="email"> <input type="submit">
            </form>
          </div>
        </div>
      </div>
...
<!--           Choose to Add/Edit/Delete Movie and Crew and Add Genres     -->
        <br></br><br>Choose to Add/Edit/Delete Movie and Crew and Add Genres:</br>
        <form action="addGenre.php" method = "post">
          Genre: <input type="textbox" name="addGenre" value="Genre">
          Title: <input type="textbox" name="addGenreToTitle" value="Movie Title">
          <input type="submit" name="form" value="Submit">
        </form>
        <ul class="nav navbar-nav">
          <li class="active"><a href = "addMovieCrewForm.php"> Click to Add a Movie </a></li>
        </ul>
        <ul class="nav navbar-nav">
          <li class="active"><a href = "editMovieCrewForm.php"> Click to Update a Movie </a></li>
        </ul>
        <ul class="nav navbar-nav">
          <li class="active"><a href = "deleteMovieCrewform.php"> Click to Delete a Movie </a></li>
        </ul>
        <ul class="nav navbar-nav">
          <li class="active"><a href = "addMovieCrewForm.php"> Click to Add a Crew Member </a></li>
        </ul>
        <ul class="nav navbar-nav">
          <li class="active"><a href = "editMovieCrewForm.php"> Click to Update a Crew Member </a></li>
        </ul>
        <ul class="nav navbar-nav">
          <li class="active"><a href = "deleteMovieCrewForm.php"> Click to Delete a Crew Member </a></li>
        </ul>
